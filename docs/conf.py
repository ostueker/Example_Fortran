...
project = u'Example Fortran Project'
copyright = u'2018, Oliver Stueker'
author = u'Oliver Stueker'
...
htmlhelp_basename = 'ExampleFortranProjectdoc'
...
latex_documents = [
    (master_doc, 'ExampleFortranProject.tex', u'Example Fortran Project Documentation',
     u'Oliver Stueker', 'manual'),
]
...
man_pages = [
    (master_doc, 'examplefortranproject', u'Example Fortran Project Documentation',
     [author], 1)
]
